...
path_to_output = 'D:\shmidt\Dropbox\Arbeit\MPIIB\Figures\4D';
...
cells16 = {cell16_1, cell16_2, cell16_3, cell16_4, cell16_5, cell16_6};MAX_DWELLTIME_SEC = 200
%%%%%%%%%%%%%%%%%%%%13 MER
...
erk_13 = [path_to_data '\' 'MEK13mer' '\'];
erk_16 = [path_to_data '\' 'MEK16mer' '\'];
