path_to_variable = 'D:\shmidt\Dropbox\Arbeit\MPIIB\trackmate_data\ERK16mer\20180718-02-cell1-grb2_paper'
path_to_output = 'D:\shmidt\Dropbox\Arbeit\MPIIB\Figures\2A'
MIN_TIME = 30
...
ligand_plot.axe_property('YLim', [0 19], 'XLim', [0 19], 'DataAspectRatio', [1 1 1])
ligand_plot.draw();
ligand_plot.export('file_name', 'grb2_tracks_dwelltime','export_path',path_to_output, 'file_type','svg');
close all;
...
mek_plot.axe_property('YLim', [0 19], 'XLim', [0 19],'DataAspectRatio', [1 1 1])
mek_plot.draw();
mek_plot.export('file_name', 'erk_tracks_dwelltime','export_path',path_to_output, 'file_type','svg');
close all;
...
merged_plot.axe_property('YLim', [0 19], 'XLim', [0 19], 'DataAspectRatio', [1 1 1])
merged_plot.draw();
merged_plot.export('file_name', 'grb2_erk_merged_tracks_dwelltime','export_path',path_to_output, 'file_type','svg');
close all;