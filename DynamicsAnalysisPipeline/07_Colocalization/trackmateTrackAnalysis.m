function done = trackmateAnalysis(ref_trackmatefile, listtrackmatefile, output_dir, channel, maximum_distance, minimum_association_time, minimum_dwell_time, nbins) 
   % try
        ...
        for ref_track_key = transpose(unique(dist_assoc_time_analysis_table_filtered.TRACK_KEY_ref_track_spots_table))
            ...
            to_plot.draw();
            to_plot.export('file_name', ref_track_key{1},'export_path',full_path_output_dir_plots_2D, 'file_type','pdf');
            close all;
        end
        ...
        for ref_track_key = transpose(unique(dist_assoc_time_analysis_table_filtered.TRACK_KEY_ref_track_spots_table))
            ...
            to_plot.export('file_name', ref_track_key{1},'export_path',full_path_output_dir_plots_link_cost, 'file_type','pdf');
            close all;
        end
        %% plot analysis 
        ...
        spot_concentration_plot.export('file_name', 'Spots_concentration','export_path',full_path_output_dir_analysis, 'file_type','pdf');
        close all;
        ...
        dwell_time_plot_related_not_related.export('file_name', 'Dwell_time_related_not_related','export_path',full_path_output_dir_analysis, 'file_type','pdf');
        close all;
        ...
        plot_displacement.export('file_name', 'Displacement_related_not_related','export_path',full_path_output_dir_analysis, 'file_type','pdf');
        close all;
        ...
        for trackmatefile = listtrackmatefile
            ...
            to_plot.set_names('x', 'Position X', 'y', 'Position Y', 'Color', 'Dwelltime');
            to_plot.draw();
            to_plot.export('file_name', 'tracks_dwelltime','export_path',full_path_output_dir_analysis, 'file_type','pdf');
            close all;
        ...
        try
            ...
            gg_hist_col.draw();
            gg_hist_col.export('file_name', 'Dwelltime_dist_col','export_path',full_path_output_dir_analysis_hl, 'file_type','pdf');
            close all;
